...
function showContactSlide(index) {
    ...
    contactSlides[contactIndex].classList.add("active");
}

// BUTTONS
function changeContactSlide(n) {
    showContactSlide(contactIndex + n);
}